...
export class ProductComponent implements OnInit {
  ...
  private websocketService :WebstockService = inject(WebsocketService);
  ...
  updateOrder(productId: number) {
    ...
    this.websocketService.sendOrderUpdate({ productId, status: 'Processing' } as {productId: number; status: string});
  }
